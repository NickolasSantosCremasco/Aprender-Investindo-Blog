                        ...
                        <SwiperSlide key={index} className="flex items-center justify-center">
                            ...
                            >
                                ...
                                <div className="flex-1 text-center md:text-left p-2">
                                    ...
                                    <h2 className="hero-title text-white text-5xl md:text-6xl font-extrabold leading-tight mb-5 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                                        {slide.title}
                                    </h2>
