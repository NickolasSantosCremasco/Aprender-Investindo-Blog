                ...
                <section className='max-w-screen-xl shadow-xl mx-auto flex flex-col'>
                    ...
                    <div className='relative w-full h-[400px] md:h-[500px] overflow-hidden'>
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center md:justify-center pl-6 md:pl-16 gap-1 text-white">
                            ...
                            <h2 className="text-sm md:text-xl opacity-80 px-5">{subtitle}</h2>
                            <p className="text-xs md:text-sm mt-1 px-5">Por <span className="font-semibold">Nickolas Cremasco</span> - {new Date(createdAt).toLocaleDateString('pt-BR', {
                                day: '2-digit',
                                month: 'long',
                                year: 'numeric'
                            })}</p>
